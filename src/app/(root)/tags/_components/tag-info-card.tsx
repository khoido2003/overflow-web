...
const TagInfoCard = ({ tag }: { tag: TagInfo }) => {
  return (
    <Link
      href={`/tags/${tag.id}`}
      className="flex flex-1 flex-col items-start gap-2 rounded-xl border border-[#C8CBD954] bg-white px-8 py-6 shadow-md dark:border-[#151821] dark:bg-[#0F1117] md:gap-5 md:px-10 md:py-8"
    >
