...
export const API_UPLOATHING =
  "https://overflow-api.onrender.com/api/uploadthing";
...
export const DEFAULT_JOB_PAGE_SIZE = 8;

export const JOB_API_URL = "https://jobicy.com/api/v2/remote-jobs?industry=dev";
